...
# Colour-blind-friendly palette shared with draw_fmcw_principle.py.
NAVY = "#17324D"
BLUE = "#2474B5"
CYAN = "#39A9C6"
TEAL = "#2D8C8C"
...
def validate_current_config() -> None:
    ...
    config = _literal_train_config(ROOT / "train_cfg.py")
    mismatches = {
    ...
    if mismatches:
        ...
        raise RuntimeError(
            "train_cfg.py has changed, so this model7 diagram must be updated: "
            + details
        )
